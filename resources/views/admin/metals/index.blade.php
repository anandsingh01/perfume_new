                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown">
                            <li>
                                <a href="{{url('admin/add-metals')}}" class="btn btn-success">
                                ...
                                @if(!empty($projects))
                                    @foreach($projects as $projectss)
                                        <tr>
                                            ...
                                            <td class="" style="">
                                                <a href="{{url('admin/edit-metals/'.$projectss->id)}}" class="btn btn-primary waves-effect waves-float btn-sm waves-green"><i class="zmdi zmdi-edit"></i></a>
        ...
        $(function() {
            $('.status').click(function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{url("admin/change-status-metals")}}',
        ...
        function deleteConfirmation(id) {
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        type: 'get',
                        url: "{{url('admin/delete-metals')}}/" + id,
