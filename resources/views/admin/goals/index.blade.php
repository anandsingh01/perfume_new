                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown">
                            <li>
                                <a href="{{url('admin/add-goals')}}" class="btn btn-success">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table dataTable js-exportable">
                                ...
                                @if(!empty($goals))
                                    @foreach($goals as $goalss)
                                        <tr>
                                            <td>{{$goalss->goal_name}}</td>
                                            <td>
                                                @if($goalss->background_image != NULL)
                                                    <img src="{{asset('/'.$goalss->background_image)}}" style="height:100px;"/>
                                                @endif
                                            </td>
                                            <td>
                                                @if($goalss->status == 1)
                                                ...
                                                <a href="javascript:void(0)" data-id="{{$goalss->id}}"
                                            ...
                                            <td class="" style="">
                                                <a href="{{url('admin/edit-goals/'.$goalss->id)}}" class="btn btn-primary waves-effect waves-float btn-sm waves-green"><i class="zmdi zmdi-edit"></i></a>
                                                <a href="javascript:void(0);" onclick="deleteConfirmation({{$goalss->id}})" class="btn btn-primary waves-effect waves-float btn-sm waves-red"><i class="zmdi zmdi-delete"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
        ...
        $(function() {
            $('.status').click(function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{url("admin/change-status-goals")}}',
