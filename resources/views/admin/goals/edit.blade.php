...
@section('body')
    ...
    <div class="container-fluid">
        <form class="form" action="{{url('admin/update-goals')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    ...
                                    <input type="number" class="form-control" name="sequence" value="{{$goals->sequence}}" />
                                </div>
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    <label class="control-label" for="password"> SDG </label>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="input-group masked-input mb-3">
                                        <input type="file" class="form-control" name="background_image" placeholder="">
                                        @if($goals->background_image)
                                            <img src="{{asset($goals->background_image)}}" style="width: 100px;"/>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="input-group masked-input mb-3">
                                        <input type="file" class="form-control" name="icon_image" placeholder="">
                                        @if($goals->icon_image)
                                            <img src="{{asset($goals->icon_image)}}" style="width: 100px;"/>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <label>About</label>
                                    <div class="input-group masked-input mb-3">
                                        <textarea  id='about' name="goal_desc" required
                                                   class='form-control p-textarea summernote'
                                                   placeholder='Write your hobby..'>{{$goals->goal_desc}}</textarea><br />
                                    </div>
                                </div>
