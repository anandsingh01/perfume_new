                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown">
                            <li>
                                <a href="{{url('admin/add-project')}}" class="btn btn-success">
                                ...
                                @if(!empty($projects))
                                    @foreach($projects as $projectss)
                                        <tr>
                                            ...
                                            <td class="" style="">
                                                <a href="{{url('admin/edit-project/'.$projectss->id)}}" class="btn btn-primary waves-effect waves-float btn-sm waves-green"><i class="zmdi zmdi-edit"></i></a>
        ...
        $(function() {
            $('.status').click(function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{url("admin/change-status-project")}}',
