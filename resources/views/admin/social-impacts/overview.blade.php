...
@section('body')
    ...
    <div class="container-fluid">
        <form class="form" action="{{url('admin/update-social-impacts')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row">
                                <input type="hidden" name="sustainability_type" value="{{$_GET['type']}}">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <label>Content</label>
                                    <div class="input-group masked-input mb-3">
                                        <textarea  id='about' name="text" required class='form-control p-textarea summernote'>{{$core_comp->text}}</textarea><br />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        @if($core_comp->gallery != 'NULL' || !empty($core_comp->gallery))
                                        <?php $imagePaths = $core_comp->gallery;

                                            $imageArray = json_decode($imagePaths); // Convert the JSON string to an array

                                        ?>
                                        @forelse($imageArray as $imagePath)
                                            <div class="item">
