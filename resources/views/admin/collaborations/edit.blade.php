...
@section('body')
    ...
    <div class="container-fluid">
        <form class="form" action="{{url('admin/update-collaborations')}}" method="post" enctype="multipart/form-data">
...
{{--                                    <div class="input-group masked-input mb-3">--}}
{{--                                        <input type="text" class="form-control" name="yt_vdo" value="{{$project->yt_vdo}}" placeholder="">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
...
{{--                                                   placeholder='Write your hobby..'>{{$project->project_content}}</textarea><br />--}}
