...
@section('body')
    ...
    <div class="container-fluid">
        <form class="form" action="{{url('admin/save-project-details')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    ...
                                    <select class="form-control" name="project_id">
                                        @forelse($projects as $projectss)
                                        <option value="{{$projectss->id}}">{{$projectss->heading}}</option>
                                        @empty
                                            Nod Data
                                        @endforelse
                                    </select>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="input-group masked-input mb-3">
                                        <input type="text" class="form-control" name="yt_vdo" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <label>About</label>
                                    <div class="input-group masked-input mb-3">
                                        <textarea  id='about' name="project_content" required class='form-control p-textarea summernote' placeholder='Write your hobby..'></textarea><br />
                                    </div>
                                </div>
