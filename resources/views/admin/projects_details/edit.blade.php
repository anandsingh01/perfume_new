...
@section('body')
    ...
    <div class="container-fluid">
        <form class="form" action="{{url('admin/update-project-details')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mtb-10">
                                    ...
                                    <input type="text" class="form-control" name="heading"
                                           value="{{$project_details->heading}}"/>
                                </div>

                                <div class="col-lg-12 col-md-12 mtb-10">
                                    <label class="control-label" for="password"> Parent Project </label>
                                    <?php
//                                        print_r($project);
//                                        print_r($project_details->project_id);
                                    ?>
                                    <select class="form-control" name="project_id">
                                        @forelse($project as $projectss)
                                            <option value="{{$projectss->id}}"
                                                {{ $projectss->id == $project_details->project_id ? 'selected' : ''}}>{{$projectss->heading}}</option>
                                        @empty
                                            Nod Data
                                        @endforelse
                                    </select>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="input-group masked-input mb-3">
                                        ...
                                        @if(!empty($project_details->featured_image))
                                            <img src="{{asset($project_details->featured_image)}}" style="width:100px;">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="input-group masked-input mb-3">
                                        <input type="text" class="form-control" name="yt_vdo" value="{{$project_details->yt_vdo}}" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <label>about</label>
                                    <div class="input-group masked-input mb-3">
                                        <textarea  id='about' name="project_content" required class='form-control p-textarea summernote'
                                                   placeholder='Write your hobby..'>{{$project_details->project_content}}</textarea><br />
