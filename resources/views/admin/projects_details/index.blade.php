                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown">
                            <li>
                                <a href="{{url('admin/add-project-details')}}" class="btn btn-success">
                        ...
                        <div class="table-responsive">
                            <table class="table dataTable js-exportable">
                                ...
                                @if(!empty($projects_details))
                                    @foreach($projects_details as $projectss)
                                        <tr>
                                            <td>{{$projectss->heading}}</td>
                                            <td>{{$projectss->getProjectParent->heading}}</td>
                                            <td>
                                            ...
                                            <td class="" style="">
                                                <a href="{{url('admin/edit-project-details/'.$projectss->id)}}" class="btn btn-primary waves-effect waves-float btn-sm waves-green"><i class="zmdi zmdi-edit"></i></a>
        ...
        $(function() {
            $('.status').click(function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{url("admin/change-status-project-details")}}',
        ...
        $(function() {
            $('.show_on_home').click(function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{url("admin/change-status-show_on_homet-details")}}',
                    data: {'status': status, 'id': id,'table' : table},
                    success: function(data){
                        // console.log(data);
                        // return false;
        ...
        function deleteConfirmation(id) {
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        type: 'get',
                        url: "{{url('admin/delete-project-details')}}/" + id,
